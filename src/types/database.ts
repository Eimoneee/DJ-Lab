    ...
    Tables: {
      ...
      track_analyses: {
        Row: {
          ...
          drums_analysis: string | null;
          bassline_analysis: string | null;
          groove_swing_notes: string | null;
          arrangement_timeline: string | null;
          tension_release: string | null;
          fx_notes: string | null;
          study_loop_ideas: string | null;
      ...
      artist_sound_maps: {
        Row: {
          ...
          mixing_traits: string | null;
          drum_patterns: string | null;
          bass_style: string | null;
          arrangement_tendencies: string | null;
          fx_techniques: string | null;
